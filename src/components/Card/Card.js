...
//             <div className={`card  ${calculateExamDuration(exam.exam_date).isExamOver ? 'over' : ''}`}>
//               <div className="row">
...
//                     <div className={`text-center align-items-center ${calculateExamDuration(exam.exam_date).isExamOver ? 'no-display' : ''}`}>
//                       <div className="small-card" >{calculateExamDuration(exam.exam_date).days}</div>
//                       <h5>Days</h5>
//                     </div>
//                   </div>
//                 </div>
